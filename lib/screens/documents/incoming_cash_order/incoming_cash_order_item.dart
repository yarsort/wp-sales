...
class ScreenItemIncomingCashOrder extends StatefulWidget {
  ...
  const ScreenItemIncomingCashOrder({Key? key, required this.incomingCashOrder})
      : super(key: key);
...
class _ScreenItemIncomingCashOrderState
  ...
  updateHeader() async {
    ...
    if (widget.incomingCashOrder.uidParent != '') {
      OrderCustomer orderCustomer = await dbReadOrderCustomerUID(
